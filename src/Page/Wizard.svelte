        ...
        <div class="card card-md">
            <div class="card-body text-center py-4 p-sm-5">
                ...
                <p class="text-muted">Tabler comes with tons of well-designed components and features. Start your
                    adventure with Tabler and make your dashboard great again.</p>
            </div>
                ...
                <span class="input-group-text">
                  https://tabler.io/
                    ...
                    <div class="form-hint">Choose a URL that describes you or your business in a concise way. Make it
                        short and easy to remember so you can share links with ease.
                    </div>
                </div>
                <div>
                    ...
                    <select class="form-select mb-0">
                        ...
                        <option value="CEDT" selected>(UTC+01:00) Belgrade, Bratislava, Budapest, Ljubljana, Prague
                        </option>
