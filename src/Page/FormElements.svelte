                            ...
                            <span class="input-group-text">
                              https://tabler.io/users/
                                            ...
                                            <input type="text" class="form-control ps-0"
                                                   value="yourfancyusername" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-flat">
                                            <input type="password" class="form-control"
                                                   value="ultrastrongpassword" autocomplete="off">
                                            <span class="input-group-text">
                              ...
                              <a href="#" class="link-secondary" title="Clear search" data-bs-toggle="tooltip"><svg
                                      ...
                                      stroke-linecap="round" stroke-linejoin="round"><path stroke="none"
                                                                                           d="M0 0h24v24H0z"
                                                                                           fill="none"/><line x1="18"
                                                                                                              y1="6"
                                                                                                              x2="6"
                                                                                                              y2="18"/><line
                                      x1="6" y1="6" x2="18" y2="18"/></svg>
                              </a>
                              <a href="#" class="link-secondary ms-2" title="Search settings" data-bs-toggle="tooltip"><svg
                                      xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                      viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                      stroke-linecap="round" stroke-linejoin="round"><path stroke="none"
                                                                                           d="M0 0h24v24H0z"
                                                                                           fill="none"/><circle cx="6"
                                                                                                                cy="10"
                                                                                                                r="2"/><line
                              ...
                              <a href="#" class="link-secondary ms-2 disabled" title="Add notification"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xl-12">
                                  ...
                                  <img src="./static/photos/8c13ad59f739558c.jpg"
                                       alt="Still life of mandarin oranges with leaves" class="form-imagecheck-image">
                                </span>
                                                </label>
                                            </div>
                                            <div class="col-6 col-sm-4">
                                  ...
                                  <img src="./static/photos/35b88fc04a518c1b.jpg"
                                       alt="Overhead view of macarons on a marble slab" class="form-imagecheck-image">
                                </span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color"
                                               value="#206bc4" title="Choose your color">
                                    </div>
                                    <div class="mb-3">
                                ...
                                Circle</span>
                                            ...
                                            <label class="form-selectgroup-item">
                                                ...
                                                <span class="form-selectgroup-label"><svg
                                                        ...
                                                        stroke-width="2" stroke="currentColor" fill="none"
                                                        stroke-linecap="round" stroke-linejoin="round"><path
                                                        stroke="none" d="M0 0h24v24H0z" fill="none"/><rect x="4"
                                                                                                           y="4"
                                                                                                           width="16"
                                                                                                           height="16"
                                                                                                           rx="2"/></svg>
                              ...
                              Default checkbox without description
                                  ...
                                  <label class="form-check form-check-single form-switch">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="input-mask" class="form-control"
                                               data-mask="00/00/0000" data-mask-visible="true"
                                ...
                                <div class="col-md-6 col-xl-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="calendar-simple" type="date" value="2020-06-20"
                                               class="form-control mb-2" placeholder="Select a date"/>
                                        <div class="input-icon">
                                            <input id="calendar-time" type="date" value="2020-06-20"
                                            ...
                                            <span class="input-icon-addon"><svg
                                                    ...
                                                    x1="16" y1="3" x2="16" y2="7"/><line x1="8" y1="3" x2="8"
                                                                                         y2="7"/><line x1="4"
                                                                                                       ...
                                                                                                       x2="20"
                                                                                                       y2="11"/><line
                                                    x1="11" y1="15" x2="12" y2="15"/><line x1="12" y1="15"
                                                                                           x2="12"
                                                                                           y2="18"/></svg>
                            </span>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="tags-advanced" id="select-tags-advanced"
