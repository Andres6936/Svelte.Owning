                    ...
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Compressed Sass output
                                    support (#29702)</small>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Set vertical-align on
                                    .form-check-input (#29521)</small>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Keep themed appearance for
                                    print (#29714)</small>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Use double quotes in
                                    `.stylelintrc` (#29709)</small>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Regenerate
                                    package-lock.json (#29695)</small>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Switch to the Coveralls
                                    Action (#29478)</small>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Fix npm audit
                                    vulnerability (#29677)</small>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">config.yml: update
                                    popper.js to v1.16.0 (#29624)</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Change deprecated html
                                    tags to text decoration classes (#29604)</small>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">justify-content:between ⇒
                                    justify-content:space-between (#29734)</small>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Update change-version.js
                                    (#29736)</small>
                            </div>
                            <div class="col-auto">
                                <a href="#" class="list-group-item-actions">
                    ...
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Some minor text
                                    tweaks</small>
                            </div>
                            <div class="col-auto">
                                <a href="#" class="list-group-item-actions show">
                    ...
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Link to versioned
                                    docs</small>
                            </div>
                            <div class="col-auto">
                                <a href="#" class="list-group-item-actions">
                    ...
                    <div class="list-group-item">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-truncate">
                                ...
                                <small class="d-block text-muted text-truncate mt-n1">Enable RFS for font
                                    resizing</small>
                            </div>
                            <div class="col-auto">
                                <a href="#" class="list-group-item-actions show">
                ...
                <div class="list-group list-group-flush overflow-auto" style="max-height: 35rem">
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Change deprecated html tags to text
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Sunny Airey</a>
                                <div class="text-muted text-truncate mt-n1">justify-content:between ⇒
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update change-version.js (#29736)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Set vertical-align on
                                    .form-check-input (#29521)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Keep themed appearance for print
                                    (#29714)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Use double quotes in `.stylelintrc`
                                    (#29709)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Switch to the Coveralls Action
                                    (#29478)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Fix npm audit vulnerability
                                    (#29677)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">config.yml: update popper.js to
                                    v1.16.0 (#29624)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update anchor.js to v4.2.1
                                    (#29662)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Make check label cursor customizable
                                    (#29654)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Fixed input-height-sm and
                                    input-height-lg calculations (#29653)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">package.json: Add funding property
                                    (#29646)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">dashboard/index.html: update
                                    tabler-icons to v4.24.1 (#29651)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">site/assets/js/search.js: ignore the
                                    LGTM alert (#29634)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Tighten regex a bit. If we need to
                                    make this more robust in the future, we can revert this as needed.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">example.html: use double quotes
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Example shortcode: use a regex and
                                    simplify logic.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Move docs JS one folder up.
                                    (#29632)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">progress: Fix IE overflow (#29629)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Christabel Charlwood</a>
                                <div class="text-muted text-truncate mt-n1">removing last occurences of
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update modal.md (#29621) Fix typo
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update
                                    stylelint-config-twbs-bootstrap to 0.9.0 (#29612)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Add calc() to function blacklist
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update normalizeDataKey to match the
                                    spec (#29609)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Remove redundant "Navbar divider"
                                    from "Contents" (#29601)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update .form-check to properly
                                    support gradients when enabled (#29338)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">v5: Simplify navbars by requiring
                                    containers (#29339)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Remove unneeded ESLint suppression
                                    and regenerate lock file (#29593)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">remove superflous transition
                                    parameter (#29595)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Added animation when modal backdrop
                                    is static (#29516)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Add configurable button text
                                    wrapping (#29554)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Enable eslint no-console rule except
                                    for build directory (#29585)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Fix one dev npm vulnerability.
                                    (#29568)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Geoffry Flaunders</a>
                                <div class="text-muted text-truncate mt-n1">Update hugo-bin to v0.47.0 (Hugo
                                    0.59.0) (#29562)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Rename close icon to close button
                                    (#29387)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Get rid of unneeded `div`s.
                                    (#29563)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update popper.js to v1.16.0.
                                    (#29537)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">v5: Icons docs cleanup (#29450)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">v5: Update colors to add shades and
                                    tints (#29348)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Add link to Icons site in our docs
                                    (#29544)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Skip hidden dropdowns while focusing
                                    (#29523)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Add make-col-auto mixin (#29367)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update dependabot config (#29536)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update devDependencies. (#29508)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Mallory Hulme</a>
                                <div class="text-muted text-truncate mt-n1">Fix top level ampersand (#29518)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Group line-height variables
                                    (#29466)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Add color argument to button mixins
                                    (#29444)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Add new .bg-body utility class
                                    (#29511)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Drop support for Node.js 8.
                                    (#29496)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Rename "js/tests/units" to
                                    "js/tests/unit". (#29503)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Perren Keemar</a>
                                <div class="text-muted text-truncate mt-n1">CI: move `CI` env variable to the
                                    root of the workflow. (#29499)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update devDependencies. (#29447)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Add variable for
                                    `$breadcrumb-font-size` (#29467)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">add modularity integration test
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">return to the original file
                                    structure to avoid breaking modularity
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Paweł Kuna</a>
                                <div class="text-muted text-truncate mt-n1">Fix border for single card in
                                    accordion (#29453)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Trim trailing whitespace from
                                    markdown files (#29460)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Maryjo Lebarree</a>
                                <div class="text-muted text-truncate mt-n1">Remove appearance from textarea
                                    (#29455)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">v5: .form-check layout changes
                                    (#29322)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Emmy Levet</a>
                                <div class="text-muted text-truncate mt-n1">Remove "extra" section from
                                    composer.json (#29420)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Jeffie Lewzey</a>
                                <div class="text-muted text-truncate mt-n1">coveralls: Add
                                    `COVERALLS_GIT_BRANCH` (#29458)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">workflows/test.yml: specify
                                    `CI=true` (#29440)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">README.md: link to the Actions page
                                    for Tests (#29480)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Variable carousel indicator opacity
                                    (#29468)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Remove outline from select box in FF
                                    (#29445)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Remove duplicated td selector
                                    (#29454)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Change blue and pink colors to be
                                    accessible. (#29198)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Sass: remove redundant stylelint
                                    inline suppressions. (#29427)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">`update-deps`: remove moot
                                    `cross-env` call. (#29419)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Grid card example tweaks (#29409)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">.eslintrc.json: Remove a couple of
                                    default rules.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Lorry Mion</a>
                                <div class="text-muted text-truncate mt-n1">Use Hugo for our docs Sass and JS.
                                    (#29280)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">examples: darken gray a little
                                    bit.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">card.md: use `text-dark` for warning
                                    card.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">badge.md: use `text-dark` for
                                    warning.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Tweak syntax highlighting colors to
                                    be WCAG2AA valid.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">workflows/test.yml: switch to
                                    `setup-node@v1`. (#29410)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Fix incorrect aspect ratio on IE11
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update devDependencies. (#29381)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Egan Poetz</a>
                                <div class="text-muted text-truncate mt-n1">Make sure the content doesn't cover
                                    the navbar dropdown
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">about/brand.md: Remove unused
                                    class.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Move shortcodes used only once where
                                    they are needed.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">getting-started/theming.md: throw an
                                    error if the regex doesn't succeed.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">homepage: remove redundant class
                                    (#29357)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update subnav to remove breadcrumb
                                    and just keep versions and search (#29368)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Update devDependencies. (#29349)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Haskel Shelper</a>
                                <div class="text-muted text-truncate mt-n1">Tweak form validation snippet.
                                    (#29359)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Examples: use our utilities more.
                                    (#29358)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Use the example shortcode in more
                                    places. (#29346)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Kellie Skingley</a>
                                <div class="text-muted text-truncate mt-n1">ESLint: specify
                                    `--report-unused-disable-directives` (#29350)
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Docs: simplify a few Hugo `range`s.
                                    (#29333)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Fix a few redirected links.
                                    (#29352)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                <a href="#" class="text-body d-block">Dunn Slane</a>
                                <div class="text-muted text-truncate mt-n1">Fix shortcodes/example.html class
                                    bug. (#29344)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Allow override default col width
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Move margins, and equal height via
                                    utility example
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">First pass at .row-cols classes
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">card.md remove empty `class`
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">carousel.md: Remove duplicate
                                    bd-example div. (#29341)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">Clean up line heights & add line
                                    height utilities (#29271)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col text-truncate">
                                ...
                                <div class="text-muted text-truncate mt-n1">docs-sidebar.html: reindent.
                                    (#29337)
                                </div>
                            </div>
                        </div>
